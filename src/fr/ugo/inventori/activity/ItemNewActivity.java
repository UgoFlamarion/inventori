...
/**
 * An activity representing a single Item detail screen. This activity is only used on handset devices. On tablet-size devices, item details are presented side-by-side with a list
 * of items in a {@link ItemListActivity}.
 * <p>
 * This activity is mostly just a 'shell' activity containing nothing more than a {@link ItemDetailFragment}.
 */
public class ItemNewActivity extends AbstractFragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			getSupportFragmentManager().beginTransaction().add(R.id.item_new_container, fragment).commit();
		}
	}
	...
	public void addNewItem(View view) {
		String label = ((EditText) findViewById(R.id.item_label)).getText().toString();
		String quantity = ((EditText) findViewById(R.id.item_new_quantity)).getText().toString();
